...
export default function AddItemModal({ isOpen, onClose, onSuccess }: AddItemModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4 modal-content">
        <div className="px-6 py-4 rounded-t-xl border-b bg-indigo-50 border-indigo-100">
          <h3 className="text-lg font-semibold text-indigo-800">➕ Add New Item</h3>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm transition-all bg-white"
              >
